...
@pytest.mark.parametrize('func_str,field,cell', [
    ('ateds._set_KickAngle', 'x_kick', 0), ('ateds._set_PolynomA', 'a1', 1),
    ('ateds._set_KickAngle', 'y_kick', 1), ('ateds._set_PolynomB', 'b1', 1),
    ('ateds._set_BendingAngle', 'b0', None), ('ateds._set_PolynomB', 'b2', 2),
...
def test_elem_get_value(at_elem_preset, field, value):
    ateds = atip.sim_data_sources.ATElementDataSource(at_elem_preset, 6,
                                                      mock.Mock(), [field])
...
def test_elem_get_orbit(at_elem_preset):
    ...
    ateds = atip.sim_data_sources.ATElementDataSource(at_elem_preset, 6, atsim,
                                                      ['x', 'y'])
