...
"""
NOT_SIMULATED_FIELDS = ['db0', 'enabled', 'x_fofb_disabled', 'x_sofb_disabled',
...
def load(lattice, LATTICE_FILE=None):
    ...
    for e in lattice:
        ...
        e.set_data_source(ATElementDataSource(ring[e.index-1], at_interface, sim_fields), pytac.SIM)
    return lattice
